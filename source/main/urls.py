...
from webapp.views import index_view, product_detail_view, search_view, create_view, update_view, delete_view
...
urlpatterns = [
    ...
    path('record/<int:pk>/delete/', delete_view, name='price_delete'),
]
